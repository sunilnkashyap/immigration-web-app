          ...
          <div className="half">
            ...
            <div className="ctc-zn" id="ContactV2Zone">
              <form
                ...
                action="https://www.immigrationattorneyhelp.com/practice-areas/"
              >
                    ...
                    <ul className="flx-grd-sml-blk-500 cls-gp-500">
                      <li className="half">
                        <div className="input-text">
                          <label htmlFor="ContactForm_ITM0_FirstName">
                            First Name
                          </label>
                          <input
                            required
                      ...
                      <li className="half">
                        <div className="input-text">
                          <label htmlFor="ContactForm_ITM0_LastName">
                            Last Name
                          </label>
                          <input
                            required
                      ...
                      <li className="half">
                        <div className="input-text">
                          <label htmlFor="ContactForm_ITM0_Phone">Phone</label>
                          <input
                            required
                            type="tel"
                      ...
                      <li className="half">
                        <div className="input-text">
                          <label htmlFor="ContactForm_ITM0_EmailAddress">
                            Email
                          </label>
                          <input
                            required
                      ...
                      <li className="sel full">
                        <div className="input-text">
                          <label htmlFor="ContactForm_ITM0_LeadTypeID">
                      ...
                      <li className="msg full">
                        <div className="input-text">
                          <label htmlFor="ContactForm_ITM0_Message">
                            How can we help you?
                          </label>
                          <textarea
                            required
