    ...
    <header id="HeaderZone" className={mainMenu ? "mnu-opn" : ""}>
        ...
        >
          ...
          <li>
            <button
              ...
              data-action="content"
            >
              <svg viewBox="0 0 36 36" className="acc-i mrg_rt">
      ...
      >
        <div className="flx-blk-800 f_sb rlt">
          <div
            className={`lg-bx bg-bx lk-bg flx f_m fit pd_tp-60 pd_bt-60 pd_h-20 ${
          ...
          <div className="ato">
            ...
            <div className="nv-bx bg-bx ulk-bg alt-bg flx f_m f_r pd_tp-30 pd_bt-30 rsp_pd-h">
              ...
              >
                ...
                >
                  <li
                    className={` flx ato rlt ${getSelectedClass("")}`}
                    role="menuitem"
                  >
                    <Link
                      to="/"
                  ...
                  <li
                    className={`flx f_m f_wrp ato rlt ${getSelectedClass(
                      "our-firm"
                    )}`}
                    role="menuitem"
                  >
